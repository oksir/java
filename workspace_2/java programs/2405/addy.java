/* to write a program to add two numbers or 3 numbers */
class addy
{
	public static void main(String [] args) //main class
	{
	/* Initialising the values to variables x,y,z. 
	   and performing addition operation.
	 */
		int x=10;
		int y=20;
		int z=40;
	...
	/**printing the output with the variables a,b,c.
	   and to add with different combinations */
		...
		System.out.println("addition of x and z is " +b);
		System.out.println("addition of y and z is " +c);
