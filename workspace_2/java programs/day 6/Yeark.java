...
class Yeark
{
	...
	public static void main(String args [])
	{
		...
		if(cMonth==2)
		{
			...
			{
				int days=29;
				System.out.println("Hey>>>>>It is a leap year");
		...
		{
			System.out.println("Your entered Year is : " + cYear);
			System.out.println("Enter a valid AD Year,i.e +ve (1 to any year) : " +cYear);
		}	
	}
}
